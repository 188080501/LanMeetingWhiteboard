...
Rectangle {
    ...
    property bool colorChangeing: false

    function hide() {
        if(centerRectangle.x !== mainRectangle.width)
        {
    ...
    Rectangle {
        ...
        ChooseButton {
            ...
            y: 10
            checked: true
            exclusiveGroup: penExclusiveGroup
            text: qsTr("黑")
            followColor: true
            ...
            onCheckedChanged: {
                if(checked)
                {
                    ...
                    materialUI.showSnackbarMessage(qsTr("选择了黑色"));
                    colorChangeing = false;
                }
            }
        }
        ...
        ChooseButton {
            ...
            onCheckedChanged: {
                if(checked)
                {
                    ...
                    chooseButtonDefined.textColor = Qt.rgba(0, 0, 0, 255);
                    materialUI.showSnackbarMessage(qsTr("选择了红色"));
                    colorChangeing = false;
                }
            }
        }
        ...
        ChooseButton {
            ...
            onCheckedChanged: {
                if(checked)
                {
                    ...
                    chooseButtonDefined.textColor = Qt.rgba(0, 0, 0, 255);
                    materialUI.showSnackbarMessage(qsTr("选择了绿色"));
                    colorChangeing = false;
                }
            }
        }
        ...
        ChooseButton {
            ...
            onCheckedChanged: {
                if(checked)
                {
                    ...
                    chooseButtonDefined.textColor = Qt.rgba(0, 0, 0, 255);
                    materialUI.showSnackbarMessage(qsTr("选择了蓝色"));
                    colorChangeing = false;
                }
            }
        }
        ...
        ChooseButton {
            ...
            onCheckedChanged: {
                if(checked)
                {
                    ...
                    materialUI.showSnackbarMessage(qsTr("自定义颜色"));
                }
            }
        }
