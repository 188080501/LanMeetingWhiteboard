...
Rectangle {
    ...
    function hide() {
        if(centerRectangle.x !== -1 * mainRectangle.width)
        {
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: {
                materialUI.showDialogConfirm(qsTr("退出"), qsTr("确定要退出这个画室吗？"),
                                             null,
                                             function() {
        ...
        Button {
            ...
            onClicked: {
                ...
                materialUI.showSnackbarMessage(qsTr("撤销操作"));
            }
        }
        ...
        Button {
            ...
            onClicked: {
                ...
                materialUI.showSnackbarMessage(qsTr("恢复操作"));
            }
        }
        ...
        Button {
            ...
            Connections{
                ...
                onImageSaved: {
                    materialUI.showSnackbarMessage(qsTr("保存画板") + ((succeed) ? (qsTr("成功")) : (qsTr("失败"))));
                }
            }
        }
        ...
        Button {
            ...
            Connections{
                target: WhiteboardCanvasPainter
                onImageOpened: {
                    materialUI.showSnackbarMessage(qsTr("读取画板") + ((succeed) ? (qsTr("成功")) : (qsTr("失败"))));
                }
            }
        }
        ...
        ComboBox {
            ...
            onCurrentIndexChanged: {
                ...
                if(count)
                {
                    materialUI.showSnackbarMessage(qsTr("切换至 ") + (currentIndex + 1));
                }
            }
