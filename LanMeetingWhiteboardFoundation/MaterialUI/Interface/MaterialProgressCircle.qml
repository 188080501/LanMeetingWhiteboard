...
Controls.ProgressBar {
     ...
     */
    property color color: materialUI.primaryColor

    /*!
       The thickness of the progress circle's stroke,
       3 dp by default
     */
    property real dashThickness: materialUI.dp(3)

    property bool showPercentage: false
    property bool autoChangeColor: false

    width: materialUI.dp(32)
    height: materialUI.dp(32)
    ...
    Text {
        ...
        font.pixelSize: materialUI.dp(14)
    }
}
